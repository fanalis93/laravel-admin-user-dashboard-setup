...
<body class="font-sans text-gray-900 bg-[#2F373F] antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-900">
        ...
        <div class="title mr-auto mt-20 mb-10">
            <h1 class="text-xl text-center text-white font-bold">Demo</h1>
            <h2 class="text-2xl text-center text-white">Admin Portal Login</h2>
        </div>
